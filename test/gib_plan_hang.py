...
gib_id = 0
v, f = igl.read_triangle_mesh("datasets/gibson_hang/"+str(gib_id)+"/mesh_z_up_scaled.off")        
print(gib_id)
...
B = np.load("datasets/gibson_hang/"+str(gib_id)+"/B.npy")
...
mesh = o3d.io.read_triangle_mesh("datasets/gibson_hang/"+str(gib_id)+"/mesh_z_up_scaled.off")
