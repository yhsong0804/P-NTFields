...
womodel.load('./Experiments/test/Model_Epoch_10000_ValLoss_1.221157e-01.pt')#
...
gib_id = Box
#gib_id = Bunny
v, f = igl.read_triangle_mesh("datasets/test/"+str(gib_id)+"/model_scaled.off")        
print(gib_id)
...
B = np.load("datasets/test/"+str(gib_id)+"/B.npy")
