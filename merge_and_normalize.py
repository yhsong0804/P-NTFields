...
INPUT_FILES = [
    './datasets/gibson_3smalltree/1/original_gibson.obj', # <--- 修改这里：原始Gibson场景的路径
    './datasets/gibson_3smalltree/1/large_rock_1.obj',    # <--- 修改这里：大石头1的路径
    './datasets/gibson_3smalltree/1/large_rock_2.obj',    # <--- 修改这里：大石头2的路径
    './datasets/gibson_3smalltree/1/small_rock.obj'       # <--- 修改这里：小石头的路径
]
